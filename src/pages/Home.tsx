    ...
    <div className="content">
          ...
          <div className="about__sections">
            <div className="about__first">
              <div className="about__maxheight">
                <h1 className="h1 h1_orange">
                  25-26
                </h1>
                <h2 className="h2 h2_green h2_bottom">
                  ноября
                </h2>
              </div>
              <p>
                В Санкт - Петербурге, в рамках молодежного форума
                “Доброфорум 9.0”, вновь соберутся ведущие эксперты в
                сфере благотворительности и добровольчества,
                а также социально ответственная молодежь.
                Площадка форума всегда предоставляла своим участникам
                полезную образовательную, досуговую и полезную программы.
                Именно здесь всегда находятся решения острых и значимых
                вопросов добровольческого сообщества России.
              </p>
              <br></br>
              <p>
                “Доброфорум 9.0” - это место притяжения людей,
                окруженных историями, которые вдохновляют, помогают осознать
                свое настоящее и поверить в будущее, открывают для нас мир
                глазами других людей. Это место силы не только для успешных
                волонтеров и лидеров мнений, но и для тех людей, кто уже сегодня
                готов начать помогать, но не знает с чего начать и где найти
                возможности для реализации своих потребностей, желаний и идей.
              </p>
              <br></br>
              <p>
                Впервые форум пройдет в онлайн-формате, но от этого станет лишь
                более запоминающимся и полезным. Следуя современным трендам,
                Организационный комитет форума подготовил для каждого участника
                QR-викторину, лишь 700 счастливчиков которой получат памятные
                брендированные подарки. Стань частью значимого волонтерского
                события Северной столицы и успей зарегистрироваться!
              </p>
              <div className="about__button">
                <NavLink to="/вход">
                  <button className="button button_green button_medium">
                    Регистрация
                  </button>
                </NavLink>
              </div>
            ...
            <div className="about__second">
              <div className="about__maxheight">
                ...
                <h2 className="h2 h2_small h2_green">
                  онлайн форума
                </h2>
              </div>
      ...
      <div className="programm">
        <div className="programm__title">
          <h1 className="h1 h1_green h1_max">
            Программа
          </h1>
          <h2 className="h2 h2_violet h2_small h2_bot h2_degree">
            онлайн форума
          </h2>
          <div>
      ...
      <div className="info" id={`#программа`}>
        <div className="info__firstday">
          <h1 className="h1 h1_max">
            25
          </h1>
          <h2 className="h2 h2_orange h2_small h2_bottom h2_degree">
            ноября
          </h2>
          <div>
            <h4 className="h4">
          ...
          <div>
            ...
            <p>
              Интерактивная программа. Событийное волонтерство
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              Паблик-ток
              <br />
              "Место силы: Как создать инфраструктуру для поддержки
              и развития добровольчества?
          ...
          <div>
            ...
            <p>
              Интерактивная программа. Серебряные волонтеры
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              ...
              "Экологическое просвещение.
               Как сделать свою повседневную жизнь более экологичной?"
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              Интерактивная программа. Медицинское волонтерство
            </p>
          </div>
          <div>
            <h4 className="h4">
          ...
          <div>
            ...
            <p>
              Интерактивная программа. Инклюзивное волонтерство
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              Мастер-класс
              <br />
              "Точка роста: как создать персональный бренд с 0?"
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              Интерактивная программа. Студенческое волонтерство
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              Паблик-ток
              <br />
              "Удивительные истории добрых людей"
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              Интерактивная программа. Экологическое волонтерство
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              ...
              <br />
              Спектакль в формате сторителлинга "Люди добрые"
            </p>
          </div>
        </div>
        <div className="info__secondday">
          ...
          <div>
            ...
            <p>
              Мастер-класс
              <br />
              "Сторителлинг для презентации твоих идей"
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              Интерактивная программа. Юные волонтеры
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              Мастер-класс
              <br />
              "Умное планирование: волонтерство, работа и саморазвитие"
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              Интерактивная программа. Патриотическое волонтерство
            </p>
          </div>
          <div>
            <h4 className="h4">
          ...
          <div>
            ...
            <p>
              Интерактивная программа. Культурное волонтерство
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              Сессия
              <br />
              "Бизнес и НКО: истории создания
              успешных социальных коллабораций"
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              Интерактивная программа. Медиа-волонтерство
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              Паблик-ток
              <br />
              "Навыки будущего: в каких сферах будут
               востребованы волонтерские компетенции"
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              Интерактивная программа. Волонтерство в ЧС
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              ...
              "Все гениальное просто:
               истории создания успешных благотворительных проектов"
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              Интерактивная программа. #МыВместе
            </p>
          </div>
          <div>
            <h4 className="h4">
            ...
            <p>
              ...
              <br />
              - Церемония вручения правительственной
              награды за вклад в развитие добровольчества
              (волонтерства)
              <br />
              - Церемония награждения победителей премии
              “ФОРМА ДОБРА. Топ-25 Самые добрые люди
              Петербурга”
              <br />
              - Выступления известных исполнителей: NATAN и Клава Кока
            </p>
          </div>
        </div>
      </div>
      <div className="speakers">
        <div className="wrapper">
          ...
          <h2 className="h2 h2_green h2_bot">
            онлайн форума
          </h2>
          <div className="speakers__who">
            <div className="speakers__block">
              ...
              <div className="speakers__hover">
                ...
                <p>
                  Российский актёр театра и кино, телеведущий
                </p>
              </div>
            </div>
            ...
            <div className="speakers__block">
              ...
              <div className="speakers__hover">
                ...
                <p>
                  Руководитель ГБУ ЛО "Ресурсный добровольческий центр"
                </p>
              </div>
            </div>
            ...
            <div className="speakers__block">
              ...
              <div className="speakers__hover">
                ...
                <p>
                  Исполнительный директор Ди-Групп Сошиал
                </p>
              </div>
            </div>
            ...
            <div className="speakers__block">
              ...
              <div className="speakers__hover">
                ...
                <p>
                  Президент фонда "Доброделы Петербурга",
            ...
            <div className="speakers__block">
              ...
              <div className="speakers__hover">
                ...
                <p>
                  Генеральный директор ООО "Сэнди"
                </p>
              </div>
            </div>
            ...
            <div className="speakers__block">
              ...
              <div className="speakers__hover">
                ...
                <p>
                  Организатор движения фудшеринг и
                  бесплатных обедов «Еда без границ»
                </p>
              </div>
            </div>
            ...
            <div className="speakers__block">
              ...
              <div className="speakers__hover">
                ...
                <p>
                  Врач уличной медицины, руководитель
                  проекта "Благотворительная Больница"
                </p>
              </div>
            </div>
            ...
            <div className="speakers__block">
              ...
              <div className="speakers__hover">
                ...
                <p>
                  Независимый консультант по фандрайзингу
            ...
            <div className="speakers__block">
              ...
              <div className="speakers__hover">
                ...
                <p>
                  и.о. Руководителя отдела фандрайзинга
            ...
            <div className="speakers__block">
              ...
              <div className="speakers__hover">
                ...
                <p>
                  Директор по коммуникациям БФ "КАФ"
                </p>
              </div>
            </div>
            ...
            <div className="speakers__block">
              ...
              <div className="speakers__hover">
                ...
                <p>
                  Социальный предприниматель, основатель
                  и руководитель проекта "Мир на ощупь".
                </p>
              </div>
            </div>
            ...
            <div className="speakers__block">
              ...
              <div className="speakers__hover">
                ...
                <p>
                  Руководитель Центра инклюзивных проектов
                  и социальной интеграции детей с особыми
            ...
            <div className="speakers__block">
              ...
              <div className="speakers__hover">
                ...
                <p>
                  Основатель "Переработкинской",
                  эксперт в сфере обращения с отходами
                </p>
              </div>
            </div>
            ...
            <div className="speakers__block">
              ...
              <div className="speakers__hover">
                ...
                <p>
                  Руководитель социальных проектов фонда "Клуб добряков"
                </p>
              </div>
            </div>
            ...
            <div className="speakers__block">
              ...
              <div className="speakers__hover">
                ...
                <p>
                  ...
                  поддержки добровольчества Республики Башкортостан
                </p>
              </div>
            </div>
        ...
        <div className="broadcast__info">
          <div className="wrapper">
            <h1 className="h1 h1_max h1_violet">
              ПРЯМАЯ ТРАНСЛЯЦИЯ - 1 ДЕНЬ
            </h1>
            <h2 className="h2 h2_white h2_degree2">
              Вдохновляйся. Совершенствуйся.
            </h2>
          </div>
          <div className="broadcast__video">
            <iframe
              title="day1"
              src="https://vk.cc/c0dWz9"
              width="820"
              height="579"
          ...
          <div className="broadcast__video">
            <iframe
              title="spectacle"
              src="https://vk.cc/c0dWAd"
              width="820"
              height="579"
              frameBorder="0"></iframe>
          </div>
          <div className="wrapper">
            <h1 className="h1 h1_max h1_green h1_nowrap">
              ПРЯМАЯ ТРАНСЛЯЦИЯ - 2 ДЕНЬ
            </h1>
            <h2 className="h2 h2_white h2_top">
              Начни с себя менять свой город
            </h2>
          </div>
          <div className="broadcast__video broadcast__video_green">
            <iframe
              title="day2"
              src="https://vk.cc/c0dWBe"
              width="820"
              height="579"
              frameBorder="0"></iframe>
          </div>
      ...
      <div className="quiz__text"  id={`#викторина`}>
        ...
        <p>
          Все очень просто: во время трансляции образовательных треков
          на твоем экране будет появляться QR-код, который нужно отсканировать
          своим мобильным устройством. Ты окажешься на страничке Личного
          кабинета и увидишь разные, но интересные по содержанию задачи. Дай
          свои ответы, предложения по их решению и получи баллы, которые
          по завершении форума ты сможешь обменять на брендированную продукцию.
        </p>

        <p>
          Но помни, что для участия в данном интерактиве тебе,
          прежде всего, необходимо зарегистрироваться и авторизоваться
          на сайте{' '}
        </p>
      </div>
